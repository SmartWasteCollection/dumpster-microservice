...
object AzureQueries {
    ...
    const val GET_COUNT_DUMPSTER_QUERY = "SELECT COUNT() FROM digitaltwins $IS_DUMPSTER_DT_CONDITION"
    const val GET_COUNT_CP_QUERY = "SELECT COUNT() FROM digitaltwins $IS_CP_DT_CONDITION"
